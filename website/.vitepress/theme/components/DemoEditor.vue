...
const groups = ref<Group[]>([
  {
    speaker: 'カケル',
    avatar: 'カ',
    jp: 'なあ、この前の星鳴祭の動画さ、海外からコメント来てたぞ。「字幕plz」って。',
    voice: true,
    items: [{ id: 1, text: '欸，上次星鸣祭那个视频，有海外的人留言了。写着"字幕plz"。', touched: false }],
  },
  {
    speaker: 'トモリ',
    avatar: 'ト',
    jp: 'えっ、ほんとに……？ちょっと嬉しいかも。',
    voice: true,
    baseParts: [
      { t: '诶，真的', k: 'same' },
      { t: '吗', k: 'remove' },
  ...
  },
  {
    speaker: 'スバル',
    avatar: 'ス',
    jp: '三日！？いや今どき、いいツールあるから。ほら、SekaiTextってやつ。',
    voice: true,
  ...
  },
  {
    speaker: 'カケル',
    avatar: 'カ',
    jp: '翻訳から字幕焼きまで一本でいけるんだよな、それ。楽すぎて戻れん。',
    voice: true,
